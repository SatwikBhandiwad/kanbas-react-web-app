            ...
            <table className="table">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <select className="btn dropdown-item" value={user.role} onChange={(e) => setUser({ ...user, role: e.target.value })}>
                        ...
                        <td>
                            ...
                            <BsPlusCircleFill className="me-2 text-primary fs-1 text" onClick={createUser} />
                        </td>
                    </tr>
                    ...
                    {users.map((user) => (
                        <tr key={user._id}>
                            ...
                            <td>
                                ...
                                <button className="btn btn-success" onClick={() => deleteUser(user)}>
                                    <BsTrash3Fill />
                                </button>
                            </td>
